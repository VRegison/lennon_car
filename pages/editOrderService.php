...
<div class="container mt-5">
     ...
     <form>
          ...
          <div class="row">
               ...
               <div class="col-md-6">
                    <div class="form-group">
                         ...
                         <button type="button" style="background: #7da7bd;color:#fff" onclick="adicionarOpcao('servicos','itensLista','valorServico','servico','','<?=$_GET['id']?>')" class="btn  mt-3">Adicionar Serviço</button>
                    </div>
          ...
          <div class="w-100 d-flex justify-content-center">
               ...
               <button onclick="editOrderService()" style="margin: 0px auto;background: #7da7bd;color:#fff" type="button" class="w-50 mb-4 mt-3 btn">Salvar</button>
          </div>
     </form>
</div>
